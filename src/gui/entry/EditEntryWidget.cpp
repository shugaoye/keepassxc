...
{
    m_autoTypeUi->windowSequenceEdit->blockSignals(true);
    m_autoTypeUi->windowTitleCombo->blockSignals(true);
    m_autoTypeUi->customWindowSequenceButton->blockSignals(true);
    ...
    m_autoTypeUi->windowSequenceEdit->blockSignals(false);
    m_autoTypeUi->windowTitleCombo->blockSignals(false);
    m_autoTypeUi->customWindowSequenceButton->blockSignals(false);
}
